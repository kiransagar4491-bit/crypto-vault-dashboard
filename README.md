...
- **Signal tab** — Live trade setups with BUY/SELL/SNIPER badges, entry/target/stop levels, indicator + timeframe, and confidence bars (filter by All/Buy/Sell/Sniper)
